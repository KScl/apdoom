...
static hint_autocomplete_storage_t hint_autocomplete_table; // <ap_hint_autocomplete_t>
...
void apdoom_send_message(const char* msg)
{
	...
	say_packet[0]["text"] = do_hint_replacement(msg, hint_autocomplete_table);
